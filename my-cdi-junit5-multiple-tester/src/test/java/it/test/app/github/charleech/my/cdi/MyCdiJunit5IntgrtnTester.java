...
public class MyCdiJunit5IntgrtnTester {
    ...
    public void whenGreet1() {
        ...
        try {
            ...
            expected = "Hello "+ MyCdiJunit5IntgrtnTester.NAME_1;

            actual   = this.greeter.greet(MyCdiJunit5IntgrtnTester.NAME_1);
    ...
    public void whenGreet2() {
        ...
        try {
            ...
            expected = "Hello "+ MyCdiJunit5IntgrtnTester.NAME_2;

            actual   = this.greeter.greet(MyCdiJunit5IntgrtnTester.NAME_2);
