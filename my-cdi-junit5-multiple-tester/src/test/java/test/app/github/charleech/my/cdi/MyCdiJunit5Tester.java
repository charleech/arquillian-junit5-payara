...
public class MyCdiJunit5Tester {
    ...
    public void whenGreet1() {
        ...
        try {
            greeter  = new Greeter();
            expected = "Hello "+ MyCdiJunit5Tester.NAME_1;

            actual   = greeter.greet(MyCdiJunit5Tester.NAME_1);
    ...
    public void whenGreet2() {
        ...
        try {
            greeter  = new Greeter();
            expected = "Hello "+ MyCdiJunit5Tester.NAME_2;

            actual   = greeter.greet(MyCdiJunit5Tester.NAME_2);
