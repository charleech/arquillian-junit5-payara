...
public class MyCdiJunit4IntgrtnTester {
    ...
    public void whenGreet1() {
        ...
        try {
            ...
            expected = "Hello "+ MyCdiJunit4IntgrtnTester.NAME_1;

            actual   = this.greeter.greet(MyCdiJunit4IntgrtnTester.NAME_1);
    ...
    public void whenGreet2() {
        ...
        try {
            ...
            expected = "Hello "+ MyCdiJunit4IntgrtnTester.NAME_2;

            actual   = this.greeter.greet(MyCdiJunit4IntgrtnTester.NAME_2);
